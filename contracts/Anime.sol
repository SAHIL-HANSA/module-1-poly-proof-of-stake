...
contract Anime is ERC721Enumerable, Ownable {
    uint256 public constant maxQuantity = 5;
    uint256 private totalMinted;
    string public prompt = "Create a upgraded nft for nature making them look cool and attaractive.";
    string public promptDescription = "Make a captivating Abstract of nature nft with a cool and attaractive way. ";
    string private baseUrl = "https://gateway.pinata.cloud/ipfs/QmaBhXiJt1swDckcQdeLDrRpToiCr62vixoJsJoRFcFhKw";
